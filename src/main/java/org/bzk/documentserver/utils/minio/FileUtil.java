...
public class FileUtil {
    ...
    public static String getString(String filePath, String filename) {
        ...
        String line;
        try {
            @Cleanup FileInputStream inputStream = new FileInputStream(new File(filePath + filename));
    ...
    public static boolean copyFile(String fromFile, String toFile) {
        try {
            ...
            @Cleanup OutputStream fosto = new FileOutputStream(toFile);
    ...
    public static void toZip(String outDir, boolean keepDirStructure, String... srcDir) {
        try {
            @Cleanup OutputStream out = new FileOutputStream(new File(outDir));
     ...
     * @return
     */
    public static boolean existsSuffix(MultipartFile multipartFile) {
        if (!multipartFile.getOriginalFilename().endsWith(".json") || multipartFile.getSize()<1){
            return true;
        }
        return false;
    }
    ...
    public static MultipartFile getMultipartFile(InputStream inputStream, String fileName) {
        FileItem fileItem = createFileItemForInput(inputStream, fileName);
     ...
     * @return FileItem
     */
    public static FileItem createFileItemForInput(InputStream inputStream, String fileName) {
        FileItemFactory factory = new DiskFileItemFactory(16, null);
